...
train_set0 = pd.read_csv(data_path + 'Xtr0.csv')
...
train_set1 = pd.read_csv(data_path + 'Xtr1.csv')
...
train_set2 = pd.read_csv(data_path + 'Xtr2.csv')
...
# K0 = build_kernel_matrix(train_set0, 3, 1, 'mismatch') # Mismatch kernel with string length 3 and 1 mismatch
K0 = build_kernel_matrix(train_set0, 3, 0, 'spectrum')
y0 = 2*y0 - 1

# alpha0 = KRR(K0, y0, 1e-4)
alpha0 = IRLS(K0, y0, 1e-4)
...
# K1 = build_kernel_matrix(train_set1, 3, 1, 'mismatch') # Mismatch kernel with string length 3 and 1 mismatch
K1 = build_kernel_matrix(train_set1, 3, 0, 'spectrum')
y1 = 2*y1 - 1

# alpha1 = KRR(K1, y1, 1e-4)
alpha1 = IRLS(K1, y1, 1e-4)
...
# K2 = build_kernel_matrix(train_set2, 3, 1, 'mismatch') # Mismatch kernel with string length 3 and 1 mismatch
K2 = build_kernel_matrix(train_set2, 3, 0, 'spectrum')
y2 = 2*y2 - 1

# alpha2 = KRR(K2, y2, 1e-4)
alpha2 = IRLS(K2, y2, 1e-4)
